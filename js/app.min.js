(() => {
          ...
          void 0 !== a &&
            ...
            (p(e[i]) && p(n[i])
              ? n[i].__swiper__
                ...
                : u(e[i], n[i])
              : !p(e[i]) && p(n[i])
              ? ((e[i] = {}), n[i].__swiper__ ? (e[i] = n[i]) : u(e[i], n[i]))
              : (e[i] = n[i]));
        }
      }
    }
  ...
  var D = {
    ...
    updateSlides: function () {
        ...
        if (
          ...
          if ("auto" === s.slidesPerView) {
            ...
            if (
              ...
              I = e.isHorizontal() ? E(n, "width", !0) : E(n, "height", !0);
            else {
              const e = t(a, "width"),
                s = t(a, "padding-left"),
                i = t(a, "padding-right"),
            ...
            (I = (a - (s.slidesPerView - 1) * T) / s.slidesPerView),
              s.roundLengths && (I = Math.floor(I)),
      ...
      if (
        ...
        M && e.grid.updateWrapperSize(I, u),
        !s.centeredSlides)
      ) {
        const t = [];
      ...
      if (
        ...
        h(i, "--swiper-centered-offset-before", -u[0] + "px"),
          h(
            i,
      ...
      for (let e = 0; e < i.length; e += 1) {
        ...
        const c =
          ...
          v =
            ...
            (h > 1 && h <= t.size) ||
            (u <= 0 && h >= t.size);
        v && (t.visibleSlides.push(o), t.visibleSlidesIndexes.push(e)),
          k(o, v, s.slideVisibleClass),
          k(o, m, s.slideFullyVisibleClass),
          (o.progress = n ? -c : c),
    ...
    updateSlidesClasses: function () {
      const e = this,
        ...
        l = (e) => v(i, `.${s.slideClass}${e}, swiper-slide${e}`)[0];
      let o, d, c;
      if (a)
        if (s.loop) {
  ...
  var $ = {
    slideTo: function (e, t, s, i, n) {
      ...
      if (!(S && n) && ((u && -w === a.translate) || (!u && w === a.translate)))
        return (
      ...
      if (n.params.loop)
        if (n.virtual && n.params.virtual.enabled) r += n.virtual.slidesBefore;
          ...
          if (
            ...
            i && s && "auto" !== n.params.slidesPerView && !a && (o = !1),
            o)
          ) {
            const i = s
              ? e < n.activeIndex
        ...
        (n = parseInt(
          ...
          t.centeredSlides
            ? a < e.loopedSlides - i / 2 ||
              ...
              ? (e.loopFix(),
                (a = e.getSlideIndex(
                  v(s, `${r}[data-swiper-slide-index="${n}"]`)[0]
                )),
                o(() => {
                  e.slideTo(a);
                }))
  ...
  var H = {
    ...
    loopFix: function (e) {
      ...
      const M = b ? Math.ceil(d.length / h.grid.rows) : d.length,
        I = (b ? d[a].column : a) + (m && void 0 === n ? -v / 2 + 0.5 : 0);
      if (I < w) {
        C = Math.max(w - I, g);
  ...
  function V(e) {
    ...
    u && i.target && i.target.shadowRoot && h && (p = h[0]);
  ...
  function N(e) {
    ...
    const u = c.pageX,
      h = c.pageY;
    if (p.preventedByNestedSwiper) return (r.startX = u), void (r.startY = h);
    if (!s.allowTouchMove)
      return (
    ...
    let f = s.isHorizontal() ? m : v,
      g = s.isHorizontal()
        ? r.currentX - r.previousX
        : r.currentY - r.previousY;
    n.oneWayMovement &&
      ((f = Math.abs(f) * (l ? 1 : -1)), (g = Math.abs(g) * (l ? 1 : -1))),
      (r.diff = f),
      (f *= n.touchRatio),
      l && ((f = -f), (g = -g));
          ...
          i.currentTranslate > s.minTranslate() &&
            ...
            n.resistance &&
              (i.currentTranslate =
                s.minTranslate() -
                1 +
                (-s.minTranslate() + i.startTranslate + f) ** y)))
        : f < 0 &&
          (b &&
            S &&
            i.allowThresholdMove &&
          ...
          i.currentTranslate < s.maxTranslate() &&
            ...
            n.resistance &&
              (i.currentTranslate =
                s.maxTranslate() +
                1 -
                (s.maxTranslate() - i.startTranslate - f) ** y))),
  ...
  function q(e) {
    ...
    if ("touchend" === n.type || "touchcancel" === n.type) {
      if (
        ((i = [...n.changedTouches].find((e) => e.identifier === s.touchId)),
    ...
    for (
      ...
      void 0 !== c[e + t]
        ? (v || (m >= c[e] && m < c[e + t])) && ((f = e), (g = c[e + t] - c[e]))
        : (v || m >= c[e]) &&
    ...
    a.rewind &&
      (t.isBeginning
        ...
        : t.isEnd && (w = 0));
    const S = (m - c[f]) / g,
      E = f < a.slidesPerGroupSkip - 1 ? 1 : a.slidesPerGroup;
    if (h > a.longSwipesMs) {
      if (!a.longSwipes) return void t.slideTo(t.activeIndex);
      "next" === t.swipeDirection &&
        (S >= a.longSwipesRatio
          ? t.slideTo(a.rewind && t.isEnd ? w : f + E)
          : t.slideTo(f)),
      ...
      (n.target === t.navigation.nextEl || n.target === t.navigation.prevEl)
        ? n.target === t.navigation.nextEl
          ? t.slideTo(f + E)
          : t.slideTo(f)
        : ("next" === t.swipeDirection && t.slideTo(null !== w ? w : f + E),
      ...
      breakpoints: {
        setBreakpoint: function () {
          ...
          const l = a(),
            ...
            c = e.getBreakpoint(r, o, d);
          if (!c || e.currentBreakpoint === c) return;
          const p = (c in r ? r[c] : void 0) || e.originalParams,
            h = Z(e, i),
            m = Z(e, p),
          ...
          h && !m
            ...
            : !h &&
              ...
              e.emitContainerClasses()),
            v && !f ? e.unsetGrabCursor() : !v && f && e.setGrabCursor(),
  ...
  class te {
    ...
    getSlideIndex(e) {
      const { slidesEl: t, params: s } = this,
        i = b(v(t, `.${s.slideClass}, swiper-slide`)[0]);
      return b(e) - i;
    }
    ...
    return (
      e.params.createElements &&
        Object.keys(i).forEach((n) => {
          if (!s[n] && !0 === s.auto) {
            let a = v(e.el, `.${i[n]}`)[0];
            a || ((a = g("div", i[n])), (a.className = i[n]), e.el.append(a)),
              (s[n] = a),
              (t[n] = a);
          }
        }),
  ...
  function ie(e) {
    ...
    s({
      ...
      i("click", (e, s) => {
        ...
        (i = y(i)), (a = y(a));
        const r = s.target;
        let l = a.includes(r) || i.includes(r);
        if (t.isElement && !l) {
  ...
  function ae(e) {
    ...
    function p() {
      ...
      if (
        ...
        if (
          (s.dynamicBullets &&
            ((r = E(n[0], t.isHorizontal() ? "width" : "height", !0)),
            c.forEach((e) => {
      ...
      "string" == typeof e.el && t.isElement && (s = t.el.querySelector(e.el)),
        ...
        s &&
          ...
          (t.params.uniqueNavElements &&
            ...
            s.length > 1 && (s = s.find((e) => S(e, ".swiper")[0] === t.el))),
    ...
    i("changeDirection", () => {
      ...
      i("init", () => {
        !1 === t.params.pagination.enabled ? v() : (h(), u(), p());
      }),
      i("activeIndexChange", () => {
            ...
            on: {
              init: function () {
                this.slides.forEach(function (e, t) {
                  var s = "slide-" + (t + 1);
                  e.setAttribute("id", s), e.classList.add("slide-" + (t + 1));
                });
                ...
                document.querySelector(".swiper-pagination"),
                  ...
                  e[0].classList.add("swiper-pagination-bullet-active"),
                  e[1]?.classList.add("swiper-pagination-bullet-active-next"),
                  e[2]?.classList.add(
              ...
              slideChange: function () {
                for (
                  var t = this.activeIndex,
                    s = this.el.closest(".sec-01__body"),
                    i = 1;
                  i <= e.slides.length;
                  i++
                )
                  s.classList.remove("slide-" + i);
                s.classList.add("slide-" + (t + 1));
                ...
                n.forEach((e, t) => {
                  (e.style.left = `${r}px`),
                    ...
                    t === a
                      ...
                      : t === a - 1
                      ? e.classList.add("swiper-pagination-bullet-active-prev")
                      : t === a - 2
                      ? e.classList.add(
                          "swiper-pagination-bullet-active-prev-prev"
                        )
                      : t === a + 1
                      ? e.classList.add("swiper-pagination-bullet-active-next")
                      : t === a + 2 &&
                        e.classList.add(
                          "swiper-pagination-bullet-active-next-next"
                        );
  ...
  class re {
    constructor(e, t) {
      let s = {
        ...
        idActiveSection: 0,
        mode: e.dataset.fpEffect ? e.dataset.fpEffect : "slider",
        bullets: !!e.hasAttribute("data-fp-bullets"),
    ...
    setId() {
      for (let e = 0; e < this.sections.length; e++) {
        this.sections[e].setAttribute("data-fp-id", e);
      }
    }
    removeId() {
      for (let e = 0; e < this.sections.length; e++) {
        this.sections[e].removeAttribute("data-fp-id");
      }
    }
    setClasses() {
      ...
      for (let e = 0; e < this.sections.length; e++)
        document.documentElement.classList.remove(`fp-section-${e}`);
    ...
    checkScroll(e, t) {
      if (
        ((this.goScroll = !1),
        !this.stopEvent && t && ((this.goScroll = !0), this.haveScroll(t)))
      ) {
        this.goScroll = !1;
        const s = Math.round(t.scrollHeight - t.scrollTop);
        ((Math.abs(s - t.scrollHeight) < 2 && e <= 0) ||
          (Math.abs(s - t.clientHeight) < 2 && e >= 0)) &&
          (this.goScroll = !0);
      }
    }
    haveScroll(e) {
      return e.scrollHeight !== window.innerHeight;
    }
    removeClasses() {
      for (let e = 0; e < this.sections.length; e++) {
        const t = this.sections[e];
        t.classList.remove(this.options.activeClass),
          t.classList.remove(this.options.previousClass),
          t.classList.remove(this.options.nextClass);
      }
    }
    events() {
      (this.events = {
    ...
    setEvents() {
      ...
      document.querySelectorAll(".scroll__ic").forEach((e) => {
        e.addEventListener("click", () => {
          const e = this.activeSectionId + 1;
          e < this.sections.length && this.switchingSection(e);
        });
      });
    }
    removeEvents() {
    ...
    clickBullets(e) {
      const t = e.target.closest(`.${this.options.bulletClass}`);
      if (t) {
        const e = Array.from(this.bulletsWrapper.children).indexOf(t);
        this.switchingSection(e);
      }
    }
    setActiveBullet(e) {
      if (!this.bulletsWrapper) return;
      const t = this.bulletsWrapper.children;
    ...
    touchMove(e) {
      const s = e.target.closest(`.${this.options.activeClass}`);
      if (t.iOS()) {
        let t = e.changedTouches[0].pageY > this.lastY,
          i = !t;
        (this.lastY = e.changedTouches[0].pageY),
          s &&
            ((t && this.allowUp) || (i && this.allowDown)
              ? e.stopPropagation()
              : e.cancelable && e.preventDefault());
      }
      if (!this.clickOrTouch || e.target.closest(this.options.noEventSelector))
        return;
      let i = this._yP - e.changedTouches[0].pageY;
    ...
    wheel(e) {
      ...
      const t = e.deltaY,
        s = e.target.closest(`.${this.options.activeClass}`);
      this.checkScroll(t, s), this.goScroll && this.choiceOfDirection(t);
    }
    choiceOfDirection(e) {
      e > 0 && !1 !== this.nextSection
        ...
        : e < 0 &&
          ...
          (this.activeSectionId =
            this.activeSectionId - 1 >= 0
              ? --this.activeSectionId
              : this.activeSectionId),
        this.switchingSection(this.activeSectionId, e);
    }
    switchingSection(e = this.activeSectionId, t) {
      if (
        (t ||
          (e < this.activeSectionId
            ? (t = -100)
            : e > this.activeSectionId && (t = 100)),
        (this.activeSectionId = e),
        (this.stopEvent = !0),
        ((!1 === this.previousSectionId && t < 0) ||
          (!1 === this.nextSectionId && t > 0)) &&
          (this.stopEvent = !1),
        this.stopEvent)
      ) {
        let e;
        document.documentElement.classList.add(
          ...
          t < 0
            ? ((e = this.activeSection.dataset.fpDirectionUp
            ...
            : ((e = this.activeSection.dataset.fpDirectionDown
    ...
    setBullets() {
      if (
        ...
        e.classList.add(this.options.bulletsClass),
          this.wrapper.append(e),
          (this.bulletsWrapper = e);
      }
      if (this.bulletsWrapper)
        for (let e = 0; e < this.sections.length; e++) {
          const e = document.createElement("span");
          e.classList.add(this.options.bulletClass),
            this.bulletsWrapper.append(e);
        }
    }
    setZIndex() {
      let e = this.sections.length;
      for (let t = 0; t < this.sections.length; t++) {
        (this.sections[t].style.zIndex = e), --e;
      }
    }
    removeZIndex() {
      for (let e = 0; e < this.sections.length; e++) {
        this.sections[e].style.zIndex = "";
      }
    }
  }
  document.querySelector("[data-fp]") &&
    (e.fullpage = new re(document.querySelector("[data-fp]"), ""));
  let le = !1;
  setTimeout(() => {
    if (le) {
  ...
  const oe = document.querySelector(".chips__btn");
  oe &&
    oe.addEventListener("click", () => {
      document.documentElement.classList.add("chips-fell"),
        oe.classList.add("_clicked");
    });
  document.querySelectorAll(".video-youtube__button").forEach((e) => {
    e.addEventListener("click", function () {
      let e = `https://www.youtube.com/embed/${this.getAttribute(
        "data-youtube"
      )}?rel=0&showinfo=0`;
      ...
      const s = this.closest(".video-youtube__body"),
        i = this.closest(".video-youtube");
      (s.innerHTML = ""),
        s.appendChild(t),
        s.classList.add("video-added"),
        i.classList.add("video-play");
    });
  }),
    (window.FLS = !1),
